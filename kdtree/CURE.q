...
cure.clust:{[sample;numR;com;kd]
 ...
 insertClust:tree.insertKd/[deleteClust;rep;sami;(first idxs)];
...
cure.createTree:{[sample]
 ...
 kds:tree.insertKd1/[root;(1_sample);1_til count sample;1_til count sample]; /insert the rest of the clusters
...
cure.cure:{[sample;numR;com;numCl]
 cureTab:{[numCl;kd] (count distinct (select from kd where valid)`clust)>numCl}[numCl] cure.clust[sample;numR;com]/cure.createTree sample;
